...
const GuardarRol = async (event) => {
    ...
    const url = '/final_armamento/roles/guardarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const BuscarRoles = async () => {
    const url = '/final_armamento/roles/buscarAPI';
    const config = {
        method: 'GET'
    }
...
const ModificarRol = async (event) => {
    ...
    const url = '/final_armamento/roles/modificarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarRol = async (e) => {
    ...
    if (AlertaConfirmarEliminar.isConfirmed) {
        const url = `/final_armamento/roles/eliminar?id=${idRol}`;
        const config = {
            method: 'GET'
        }
