...
class RolController extends ActiveRecord{
    ...
    public static function guardarAPI(){
        ...
        $sql_verificar = "SELECT id_rol FROM lopez_roles 
    ...
    public static function buscarAPI(){
        try {
            $sql = "SELECT r.id_rol, r.nombre_rol, r.descripcion, r.fecha_creacion,
                           (SELECT COUNT(*) FROM lopez_usuarios u WHERE u.id_rol = r.id_rol AND u.activo = 'T') as usuarios_asignados
                    FROM lopez_roles r 
    ...
    public static function EliminarAPI(){
        try {
            ...
            $sql_verificar = "SELECT id_rol, nombre_rol FROM lopez_roles WHERE id_rol = $id";
    ...
    {
        $sql = "DELETE FROM lopez_roles WHERE id_rol = $id";
        return self::SQL($sql);
    }

    public static function UsuariosAsignadosRol($id_rol)
    {
        $sql = "SELECT COUNT(*) as total FROM lopez_usuarios WHERE id_rol = $id_rol AND activo = 'T'";
    ...
    {
        $sql = "SELECT * FROM lopez_roles ORDER BY nombre_rol";
