...
class AppController
{
    ...
    public static function login()
    {
        ...
        try {
            ...
            $query = "SELECT id_usuario, nombre_usuario, password, nombre_completo, email, id_rol FROM lopez_usuarios WHERE nombre_usuario = '$nombre_usuario' AND activo = 'T'";
    ...
    public static function hashearPassword()
    {
        ...
        echo json_encode([
            ...
            'consulta_sql' => "UPDATE lopez_usuarios SET password = '$hash' WHERE nombre_usuario = 'juanita';"
        ]);
    }
    ...
    public static function actualizarPasswordsExistentes()
    {
        ...
        try {
            $query = "SELECT id_usuario, nombre_usuario, password FROM lopez_usuarios WHERE activo = 'T'";
